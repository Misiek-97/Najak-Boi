...
{
	public class NajakPlayerController2D : MonoBehaviour
	{
		...
		[SerializeField] private LayerMask m_WhatIsDeathZone;							// A mask determining what destroys the player
		...
		private void FixedUpdate()
		{
			...
			var deathZone = Physics2D.OverlapCircleAll(m_GroundCheck.position, k_GroundedRadius, m_WhatIsDeathZone);
